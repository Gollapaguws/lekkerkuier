...
const PAGES: SitePage[] = [
  ...
  { to: '/history', title: 'Track History', description: 'Real-time recently played tracks with genre filters and album art', icon: '🎵' },
  ...
  { to: '/submit', title: 'Become a DJ', description: 'Show submission form for aspiring DJs to join the Lekkerkuier lineup', icon: '🎤' },
